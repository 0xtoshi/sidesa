      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-home"></i> <span>Dashboard</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="index-crm.html"><i class="fa fa-angle-right"></i> CRM</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content">
      ...
      <div class="row">
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="m-b-3 text-center">
                  <h6 class="f-14">Order Received</h6>
                  <h4 class="text-blue">9,530</h4>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="m-b-3 text-center">
                  <h6 class="f-14">Total Sales</h6>
                  <h4 class="text-blue">6,300</h4>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="m-b-3 text-center">
                  <h6 class="f-14">Total Profit</h6>
                  <h4 class="text-blue">$ 15,538</h4>
                </div>
              </div>
              <div class="col-lg-12">
        ...
        <div class="col-lg-4">
          <div class="box-gradient-1 box-rounded">
            <div class="card-body text-white">
              <h1>10,580</h1>
              <h5>Orders</h5>
              <div class="m-t-2"><span class="bar-colours-2">5,3,2,-1,-3,-2,2,3,5,2</span></div>
            </div>
          </div>
          <div class="box-gradient box-rounded m-t-3 m-b-3">
            <div class="card-body text-white">
              <h1>7,750</h1>
              <h5>New Users</h5>
              <div class="m-t-2"><span class="bar-colours-2">7,3,5,-5,-4,-5,2,3,5,4</span></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <div class="box box-widget widget-user-2 m-t-3 m-b-3">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-10">
                        <div class="mail-contnet">
                          ...
                          <div class="row">
                            <div class="col-lg-3 col-xs-4 m-bot-2"><img src="dist/img/img7.jpg" alt="user" class="img-responsive img-rounded m-b-1"></div>
                            <div class="col-lg-3 col-xs-4 m-bot-2"><img src="dist/img/img8.jpg" alt="user" class="img-responsive img-rounded m-b-1"></div>
                            <div class="col-lg-3 col-xs-4 m-bot-2"><img src="dist/img/img9.jpg" alt="user" class="img-responsive img-rounded m-b-1"></div>
                            <div class="col-lg-3 col-xs-4 m-bot-2"><img src="dist/img/img10.jpg" alt="user" class="img-responsive img-rounded m-b-1"></div>
                          </div>
